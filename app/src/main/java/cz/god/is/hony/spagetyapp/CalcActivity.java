...
public class CalcActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position) {
            case 1:
                omacka+=1;
                Toast.makeText(this, "Boloòská omáèka", Toast.LENGTH_SHORT).show();
                break;
            case 2:
                omacka+=2;
                Toast.makeText(this, "Sýrová omáèka", Toast.LENGTH_SHORT).show();
                break;
        }
    }
